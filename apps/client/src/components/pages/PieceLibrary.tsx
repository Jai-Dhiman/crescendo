            ...
            <div className="w-full h-full flex items-center justify-center text-gray-400">
              ...
              <div className="flex justify-between items-start">
                <div className="min-w-0 flex-1">
                  <h3 className="text-lg font-recia-medium truncate">{piece.title}
                  </h3>
                  {piece.artist && (<p className="text-sm text-gray-600 dark:text-gray-400 truncate">{piece.artist}</p>
                )}
                </div>
                <button className="btn-soft ml-4 scale-90 opacity-0 group-hover:opacity-100 transition-all shrink-0">
                  Start Practice
                  </button>
                </div>
              </div>
